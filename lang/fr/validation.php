...
return [
    ...
    */
    ...
    "accepted_if" => "Le champ :attribute doit etre validé quand :other = :value.",
    "active_url" => "Le champ :attribute doit être un URL valide.",
    "after" => "Le champ :attribute doit etre après :date.",
    "after_or_equal" => "La date :attribute doit être après ou en même temps que :date.",
    "alpha" => "Le champ :attribute ne doit contenir que des lettres.",
    "alpha_dash" => "Le champ :attribute ne doit contenir que des lettres, des chiffres, des tirets ou les caractères siuvants : `-,_`.",
    ...
    "ascii" => "Le champ :attribute ne doit contenir que des caractères et symbloes alpha numériques d'un byte.",
    "before" => "La data :attribute doit etre avant :date.",
    "before_or_equal" => "La date :attribute doit être avant ou en meme temps que :date.",
    "between" => [
